...
car.drive(1.5)
print(f"{car.get_travelled_distance():.0f}")
...
print(f"{'Reg Number':<10} {'Max Speed':<10} {'Current Speed':<10} {'Travelled Distance':<10}")
print("-" * 55)
for car in cars:
    print(f"{car.get_registration_number():<10} {car.get_maximum_speed():<10} "
          f"{car.get_speed():<14} {car.get_travelled_distance():<18.1f}")
